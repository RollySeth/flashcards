...
const UserRegistration = (data) => {
  return axios
    .post(`${process.env.REACT_APP_BASEURI}/login/signup`, data)
    .then((res) => res.status);
};
...
export const UserValidation = (data) =>
  axios
    .post(`${process.env.REACT_APP_BASEURI}/login/user`, data)
...
class SignUp extends React.Component {
  ...
  handleOnBlur = async (e) => {
    ...
    isEmailTaken === 204
      ? this.setState({
          error_email_exists: "Email already exists. Try Login Instead!",
        })
